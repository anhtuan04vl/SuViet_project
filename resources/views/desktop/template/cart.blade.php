                ...
                <table class="table-auto mt-5">
                    ...
                    <tbody>
                        @foreach ($cart->details as $detail)
                            <tr>
                                <td class="px-2 900:px-10 py-2 w-[150px]">
                                    <img src="{{ asset('img/' . $detail->product->images) }}"
        ...
        <div class="cart_sp">
            ...
            <div class="form_cp_info mt-5 flex flex-col md:flex-row gap-5 800:gap-20 justify-between">
                ...
                <div class="info w-full md:w-[50%] border-2 rounded-[15px] p-3 800:p-8 flex flex-col gap-8 800:gap-6">
                    ...
                    <a href="{{ route('order', ['users_id' => Auth::id()]) }}" class="w-full bg-cmain text-white py-2 text-center rounded-lg">Tiến hành
                        thanh Toán</a>
