            ...
            <div class="menu_des hidden lg:flex gap-8 items-center ">
                <div class="menu">
                    <ul class="flex gap-12  items-center">
                        ...
                        <li><a href="{{route ('register')}}" class="text-black font-el font-semibold text-[13px] 2xl:text-base hover:text-cmain flex items-center gap-1">Đăng Ký</a></li>
