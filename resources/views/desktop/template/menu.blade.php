            ...
            <div class="menu_des hidden lg:flex gap-8 items-center ">
                ...
                <div class="sgv flex gap-6 items-center ">
                    ...
                    <div class="account group relative">
                            ...
                            <ul class="absolute top-full bg-white invisible opacity-0 group-hover:visible group-hover:opacity-100 transition-all duration-300 w-[200px] shadow-lg rounded-md">
                                @if (!Auth::check())
                                    <li class="px-4 py-2">
