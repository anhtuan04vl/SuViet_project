    ...
    <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
        ...
        <div class="navbar-nav align-items-center ms-auto">
                ...
                <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                    <a href="#" class="dropdown-item">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-2">
                                <h6 class="fw-normal mb-0">Henry Bui gửi một tin nhắn</h6>
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                    <a href="#" class="dropdown-item">
                        <h6 class="fw-normal mb-0">Cập nhật sản phẩm ID 001</h6>
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex align-items-center dropdown-toggle" data-bs-toggle="dropdown">
                    <img src="{{ asset('img/images/' . Auth::user()->images) }}" alt="Hình sản phẩm" class="product-image d-block mx-2" style="width: 20%; border-radius: 50%;">
                ...
                <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                    ...
                    <form action="{{ route('admin.logout') }}" method="POST" id="logout-form">
                        @csrf
                        <a href="#" class="dropdown-item" onclick="document.getElementById('logout-form').submit();">Đăng xuất</a>
                    </form>
                </div>
            </div>
        </div>
